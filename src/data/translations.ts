...
export const UI_TRANSLATIONS = {
  BS: {
    ...
    pouchTitle: "Sličice u kesici (nezalijepljene)",
    pouchEmpty: "Vaša kesica je trenutno prazna. Kupite paketiće sa sličicama da sakupite igrače!",
    pouchInstructions: "* Kliknite na bilo koju sličicu u kesici da otvorite njen detaljan prikaz sa statistikama i zalijepite je na njeno mjesto u albumu.",
    mandateTitle: "Zadatak za kompletiranje albuma",
    mandateDesc: "Kompletirajte legendarni sastav od 22 bosanskohercegovačka reprezentativca i pronađite 4 \"Specijalne sličice\" (Zlatni grb, Stadion Bilino Polje, Generacija 2014, BHFanaticos) da biste osvojili verifikovani zlatni Metaplex certifikat o završetku!",
    tabAlbum: "Album sa sličicama",
    tabPacks: "Otvaranje paketića",
    ...
    welcomeText3: " kako biste započeli sakupljanje.",
    starterKit1: "Edin Džeko i Ermedin Demirović su već zalijepljeni!",
    starterKit2: "Holografski zlatni grb (S1) je zalijepljen!",
    starterKit3: "Duplikat Dennisa Hadžikadunića je dodat u Vašu kesicu!",
    starterKitButton: "Preuzmi početni set i otvori album",
    progressionTitle: "Napredak sakupljanja sličica",
    pastedCountLabel: "Zalijepljeno",
    ofLabel: "od ukupno",
    spotsLabel: "standardnih mjesta",
    progressLabel: "NAPREDAK ALBUMA",
    coverBadge: "★ SVJETSKO PRVENSTVO 2026 ★",
    coverMainTitle: "KOLEKCIJA ZMAJEVI 2026",
    coverSubtitle: "Zvanični digitalni sakupljački Web3 album",
    coverHeroes: "HEROJI REPREZENTACIJE",
    coverCollectibleSlots: "30 KOLEKCIONARSKIH MJESTA",
    coverText: "Istražite dinamične sastave, statistike igrača i učestvujte u trgovanju sličicama sa drugim sakupljačima. Kompletirajte album i preuzmite svoj Metaplex certifikat.",
    flipOpenButton: "Prelistaj album",
    wcEdition: "BIH IZDANJE - S.P. 2026",
    specialSpotsHeader: "Specijalna kolekcija",
    squadPageHeader: "Reprezentacija BiH — Stranica",
    slotRange: "Raspon pozicija",
    emptySlot: "Prazno mjesto",
    tapToView: "Kliknite za detalje",
    doubleItemBadge: "DUPLIKAT! Dostupno za razmjenu",
    closeAlbum: "Zatvori album",
    backCover: "Nazad na naslovnu",
    nextPage: "Sljedeća stranica",
    prevPage: "Prethodna stranica",
    boosterShopTitle: "Prodavnica paketića",
    boosterShopDesc: "Kupite digitalne paketiće na Solana devnet mreži koji sadrže 5 nasumičnih sličica naših reprezentativaca.",
    yourBalance: "Vaše stanje:",
    purchasePackButton: "Kupi paketić za 0.1 SOL",
    purchasingLabel: "Kupovina u toku...",
    airdropTitle: "Dopuni SOL tokene",
    airdropButton: "Preuzmi 5.0 SOL (Airdrop)",
    airdropClaimed: "SOL uspešno dodan!",
    openedLabel: "Paketić je osiguran na Solana mreži! Kliknite na paketić ispod da ga otvorite.",
    ripPackLabel: "KLIKNITE DA POCIJEPATE PAKETIĆ",
    ripMe: "OTVORI ME!",
    envelopeDesc: "Kliknite bilo gdje da pocijepate paketić",
    pulledCardLabel: "Izvučena sličica BROJ",
    claimAllButton: "Spremi svih 5 sličica u kesicu!",
    claimingLabel: "Spremanje u toku...",
    pouchClaimedSuccess: "All cards successfully deposited into your album pouch",
    tradeHubTitle: "P2P Berza za razmjenu sličica",
    tradeHubDesc: "Ponudite svoje duplikate za razmjenu ili kupite sličice koje Vam fale direktno za SOL tokene.",
    createListingTitle: "Objavi ponudu za razmjenu",
    marketListingsTitle: "Aktivne ponude na berzi",
    selectDuplicateLabel: "Odaberite duplikat iz kesice koji želite ponuditi:",
    requestedStickerLabel: "Tražena sličica (Šta želite zauzvrat):",
    anyStickerLabel: "Bilo koja sličica (Slobodna razmjena)",
    orSellForSOL: "Ili prodajte za SOL:",
    optionalSOLPrice: "SOL cijena (opcionalno)",
    createOfferButton: "Kreiraj ponudu",
    offerPostedSuccess: "Ponuda je uspješno objavljena!",
    offered: "NUDI SE",
    wanted: "TRAŽI SE",
    solPriceShort: "CIJENA",
    byOwner: "VLASNIK",
    cancelListing: "Otkaži ponudu",
    acceptSwapButton: "Prihvati razmjenu",
    buyWithSOLButton: "Kupi za SOL",
    noActiveTrades: "Trenutno nema aktivnih ponuda. Budite prvi koji će objaviti ponudu!",
    noDuplicatesToTrade: "Nemate nezalijepljenih duplikata za ponuditi na berzi.",
    predictionsTitle: "Predsjedništvo prognoza (Arena)",
    predictionsDesc: "Uložite 0.2 SOL iz virtuelnog novčanika da prognozirate ishod utakmica. Tačna prognoza Vas nagrađuje nasumičnom sličicom visoke ocjene iz nagradnog fonda!",
    clashesTitle: "Utakmice Zmajeva na Svjetskom prvenstvu:",
    kickoffDate: "KICKOFF DATUM:",
    stadium: "STADION:",
    activePredictions: "VAŠE TRENUTNO AKTIVNE PROGNOZE:",
    betInvolving: "PROGNOZA ZA",
    outcomeLabel: "Prognozirani ishod:",
    stakedLabel: "Uloženo:",
    liveLogSim: "Simulacija utakmice uživo:",
    matchOver: "Utakmica je završena!",
    matchOutcome: "Krajnji ishod:",
    yourPrediction: "Vaša prognoza:",
    guessedCorrect: "POGODILI STE! Nasumična sličica je dodata u kesicu!",
    guessedIncorrect: "Netačna prognoza! Podržite momke i pokušajte ponovo.",
    selectOutcome: "Odaberite prognozu:",
    outcomeWin: "Pobjeda BiH",
    outcomeDraw: "Neriješeno",
    outcomeLoss: "Pobjeda protivnika",
    placePredictionButton: "Uplati prognozu za 0.2 SOL",
    simulateLiveButton: "Simuliraj utakmicu uživo!",
    simulatingWait: "Simulacija 90 minuta čiste drame...",
    historyTitle: "Put do 2026.",
    historyDesc: "Zvanični arhiv kvalifikacija sakupljačkih trenutaka reprezentacije.",
    qualTitle: "Arhiva kvalifikacione borbe Zmajeva",
    qualDesc: "Pratite uzbudljivi put na kojem su Zmajevi izborili svoje mjesto među svjetskom elitom u Sjevernoj Americi nakon dramatičnih utakmica.",
    scorers: "STRIJELCI",
    mRecap: "KRATAK PREGLED:",
    overallRating: "Ukupna ocjena",
    statPace: "BRZINA",
    statShooting: "ŠUT",
    statPassing: "DODAVANJE",
    statDribbling: "DRIBLING",
    statDefending: "ODBRANA",
    statPhysicality: "FIZIČKA SPREMA",
    cardHeight: "VISINA",
    cardBirth: "DATUM ROĐENJA",
    cardClub: "KLUB",
    stationedActive: "POZICIJA U TIMU:",
    pastedStatus: "STATUS SLIČICE",
    mountedInSlot: "ZALIJEPLJENO U ALBUM",
    notYetMounted: "NIJE JOŠ ZALIJEPLJENO",
    ownDuplicates: "Imate duplikate ove sličice.",
    pasteInAlbumAction: "ZALIJEPI SLIČICU U ALBUM",
    walletNotConnected: "Povežite novčanik da biste zalijepili sličice",
    clickToFlip: "KLIKNITE DA OKRENETE SLIČICU"
  },
  EN: {
    title: "BOSNIA WORLD CUP 2026 COLLECTION",
    subtitle: "Official Collector's Web3 Sticker Album",
    arenaHum: "Arena Hum",
    connectedAddress: "CONNECTED ADDRESS",
    walletOffline: "Wallet Offline",
    pouchTitle: "Pouch Unmounted Stickers",
    ...
    tabPredictions: "Prediction Arena",
    tabHistory: "Road to 2026",
    welcomeTitle: "WELCOME COLLECTOR",
    welcomeHeader: "ZMAJEVI 2026 ALBUM",
    welcomeText1: "We have credited your virtual tray with ",
    welcomeText2: " in your sandbox wallet and placed ",
    welcomeText3: " to begin.",
    starterKit1: "Edin Džeko & Ermedin Demirović already mounted!",
    starterKit2: "Holographic Golden Crest (S1) mounted!",
    starterKit3: "Duplicate Dennis Hadžikadunić added to your pouch!",
    starterKitButton: "Claim Starter Kit & Open Album",
    progressionTitle: "Sticker Collection Progression",
    pastedCountLabel: "Pasted",
    ofLabel: "of",
    spotsLabel: "standard spots",
    progressLabel: "COLLECTION PROGRESS",
    coverBadge: "★ AISO WORLD CUP 2026 EDITION ★",
    coverMainTitle: "BOSNIA WORLD CUP 2026 COLLECTION",
    coverSubtitle: "Official Digital Web3 Sticker Album",
    coverHeroes: "ZMAJEVI HEROES",
    coverCollectibleSlots: "30 COLLECTIBLE SLOTS",
    coverText: "Explore dynamic team selections, physical sticker metrics, and verified peer-to-peer bartering. Complete your binder to mint your Metaplex album certificate.",
    flipOpenButton: "Flip Open Album",
    wcEdition: "BOSNIAN WC2026 EDITION",
    specialSpotsHeader: "Special Collection Spots",
    squadPageHeader: "Bosnian Squad — Page",
    slotRange: "Slot Range",
    emptySlot: "Empty / Unmounted Slot",
    tapToView: "Tap to View details",
    doubleItemBadge: "Double item! Available for swaps",
    closeAlbum: "Close Album",
    backCover: "Back to Cover",
    nextPage: "Next Page",
    prevPage: "Prev Page",
    boosterShopTitle: "Solana Booster shop",
    boosterShopDesc: "Acquire digital foil packs on the Solana devnet network containing 5 random licensed players.",
    yourBalance: "Your balance:",
    purchasePackButton: "Purchase Pack for 0.1 SOL",
    purchasingLabel: "Purchasing...",
    airdropTitle: "Get more tokens",
    airdropButton: "Airdrop 5.0 SOL",
    airdropClaimed: "SOL Claimed successfully!",
    openedLabel: "Pack secured on Solana devnet! Click below to tear open the sleeve.",
    ripPackLabel: "CLICK TO RIP OPEN",
    ripMe: "RIP ME!",
    envelopeDesc: "Click anywhere to open foil sleeve",
    pulledCardLabel: "Pulled sticker CARD",
    claimAllButton: "Claim All 5 Stickers to Pouch!",
    claimingLabel: "Claiming...",
    pouchClaimedSuccess: "All cards successfully deposited into your album pouch",
    tradeHubTitle: "P2P Sticker Swapping Hub",
    tradeHubDesc: "List your duplicate cards for smart-contract swapping, or purchase missing ones directly with SOL.",
    createListingTitle: "Create swap listing",
    marketListingsTitle: "Active Swap Market Listings",
    selectDuplicateLabel: "Select a duplicate sticker from your pouch to trade:",
    requestedStickerLabel: "Requested Sticker (What you want in return):",
    anyStickerLabel: "Any Sticker (Free swap)",
    orSellForSOL: "Or sell for SOL price:",
    optionalSOLPrice: "Optional SOL price",
    createOfferButton: "Create Swap Listing",
    offerPostedSuccess: "Offer posted successfully!",
    offered: "OFFERED",
    wanted: "WANTED",
    solPriceShort: "PRICE",
    byOwner: "BY",
    cancelListing: "Cancel Listing",
    acceptSwapButton: "Accept Swap",
    buyWithSOLButton: "Buy with SOL",
    noActiveTrades: "No active trades. Be the first to post a swap!",
    noDuplicatesToTrade: "You do not have any duplicates in your portfolio to swap.",
    predictionsTitle: "Prediction Arena",
    predictionsDesc: "Stake 0.2 SOL of your sandbox balance to guess match outcomes. Correct predictions reward you with a random high-rating or vintage sticker from the prize pot!",
    clashesTitle: "Upcoming Zmajevi FIFA WC Group Stage Clashes:",
    kickoffDate: "KICKOFF DATE:",
    stadium: "STADIUM:",
    activePredictions: "YOUR CURRENT ACTIVE PREDICTIONS / BETS:",
    betInvolving: "BET INVOLVING",
    outcomeLabel: "Match Outcome:",
    stakedLabel: "Staked:",
    liveLogSim: "Match Live Simulation Log Feed:",
    matchOver: "Match Over!",
    matchOutcome: "Full Time Result:",
    yourPrediction: "Your prediction:",
    guessedCorrect: "YOU GUESSED IT CORRECTLY! Random sticker claimed!",
    guessedIncorrect: "Incorrect guess! Keep supporting the team and try again.",
    selectOutcome: "Select Prediction:",
    outcomeWin: "Bosnia Win",
    outcomeDraw: "Draw",
    outcomeLoss: "Opponent Win",
    placePredictionButton: "Place Prediction for 0.2 SOL",
    simulateLiveButton: "Simulate Match Day Live!",
    simulatingWait: "Simulating 90 minutes of pure drama...",
    historyTitle: "Road to 2026",
    historyDesc: "Official qualification match reports and collection milestones archive.",
    qualTitle: "Historic Qualification Battle Archive",
    qualDesc: "Follow the intense path where the Dragons earned their spot among the elite in North America after a series of memorable confrontations.",
    scorers: "SCORERS",
    mRecap: "MATCH RECAP:",
    ...
    statPhysicality: "PHYSICALITY",
    cardHeight: "HEIGHT",
    cardBirth: "BIRTHDATE",
    cardClub: "CLUB",
    stationedActive: "STATIONED ACTIVE CELL:",
    pastedStatus: "PASTED INSTANCE STATUS",
    mountedInSlot: "MOUNTED IN SLOT",
    notYetMounted: "NOT YET MOUNTED",
    ownDuplicates: "You own duplicates of this sticker.",
    pasteInAlbumAction: "PASTE STICKER IN ALBUM",
    walletNotConnected: "Connect wallet to paste stickers in album",
...
export const PLAYER_TRANSLATIONS: Record<number, {
  ...
  14: {
    role: { BS: "Odbrambeni", EN: "CLB" },
    biography: {
      BS: "Kultni heroj odbrane sa zapaženom karijerom u turskoj ligi. Poznat po borbenosti, lavovskom srcu i čvrstim startovima na loptu koji podsjećaju na istorijski borbeni duh i ponos sa najvećih utakmica reprezentacije.",
  ...
  29: {
    ...
    biography: {
      ...
      EN: "The ultra fan group of Bosnia and Herzegovina national teams. Traveling across the globe, they paint stadiums in blue and yellow, supporting the team at all costs."
    }
  }
};
