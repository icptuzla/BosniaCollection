...
export const UI_TRANSLATIONS = {
  ...
  EN: {
    ...
    welcomeText2: " in your wallet and placed ",
    ...
    predictionsDesc: "Stake 0.2 SOL from your wallet balance to guess match outcomes. Correct predictions reward you with a random high-rating or vintage sticker from the prize pot!",
